...
##	引擎.窗口.伤害绘制(Vector2(300,300),[["命中", 20478], ["命中", 20278], ["暴击", 24311], ["暴击", 22333]])
	#引擎.窗口.伤害绘制(Vector2(300,600),123,"命中","正常")	
	#引擎.窗口.伤害绘制(Vector2(300,400),123,"暴击","正常")
	#
	#引擎.窗口.伤害绘制(Vector2(300,400),123,"命中","受伤")
	#引擎.窗口.伤害绘制(Vector2(340,400),123,"命中","补血")
	#引擎.窗口.伤害绘制(Vector2(500,400),123,"暴击","补蓝")
